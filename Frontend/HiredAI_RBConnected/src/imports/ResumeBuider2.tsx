import svgPaths from "./svg-eolftifvvh";
...
function Frame() {
  return (
    <div className="box-border content-stretch flex items-center justify-center pl-0 pr-[12.833px] py-0 relative shrink-0 w-[141px]">
...
function Frame1() {
  return (
    <div className="bg-black box-border content-stretch flex flex-col gap-[10px] items-center justify-center px-0 py-[10px] relative rounded-[8px] shrink-0 w-full">
      <Frame />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[10px] items-center justify-center left-[1509px] p-[10px] top-[986px] w-[179px]">
      <Frame1 />
    </div>
  );
}
